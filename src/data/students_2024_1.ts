...
export const Clara: Person = {
    ...
    pos: ["Membro da Organização", "Presidente", "Presidente"],
};
...
export const JoseVitor: Person = {
    ...
    course: "Ciência da Computação",
    semester: "8",
    role: "Software Engineer Inovatec-JP",
    link: "https://www.linkedin.com/in/josé-vitor-rodrigues-79b81128a/",
    photo: "/assets/pessoas/2024.1/jose.jpg",
    class: "2024.1",
    org: [],
    pos: [],
};
