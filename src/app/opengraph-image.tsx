...
export const alt =
  'Trilha — programa gratuito feito por estudantes da UFPB para apoiar quem está chegando ao Centro de Informática.';
export const size = { width: 1200, height: 630 };
export const contentType = 'image/png';

// Brand tokens (see tailwind.config.ts / CLAUDE.md design system)
const AzulMeiaNoite = '#000928';
const Branco = '#FFFAF2';
const AzulCeu = '#A0B5FF';
const AzulEletrico = '#1C4AE5';
const BrancoCreme = '#FEF7E5';
    ...
    (
      <div
        style={{
          ...
          backgroundColor: AzulMeiaNoite,
          backgroundImage: `radial-gradient(circle at 50% 18%, ${AzulEletrico}44 0%, ${AzulMeiaNoite} 60%)`,
          padding: 80,
          position: 'relative',
        }}
      >
        ...
        >
          Programa gratuito feito por estudantes da UFPB para apoiar quem está
          chegando ao Centro de Informática.
        </div>
