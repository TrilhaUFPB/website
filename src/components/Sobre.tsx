      ...
      <div className="container mx-auto px-6">
        ...
        <div className="gap-4 px-4 lg:px-24">
          <div className="flex gap-2 lg:gap-4">
            <div className="bg-VerdeMenta p-4 lg:p-10 rounded-2xl shadow-lg transform transition-transform duration-500 hover:scale-110 hover:z-10">
            ...
            <div className="bg-AzulEletrico p-4 lg:p-10 rounded-2xl shadow-lg flex-grow transform transition-transform duration-500 hover:scale-110 hover:z-10">
          ...
          <div className="flex gap-2 lg:gap-4 pt-4">
            ...
            <div className="bg-AzulCeu p-4 lg:p-10 rounded-2xl shadow-lg flex-grow transform transition-transform duration-500 hover:scale-110 hover:z-10">
              <h3 className="font-poppins font-extrabold text-xl lg:text-3xl text-BrancoCreme mb-2 mt-2 lg:mb-4 lg:mt-2">
