...
## 1. O que é HTML de verdade

### 1.1 Estrutura x aparência
...
### 1.2 HTML, CSS e JavaScript (visão geral)
...
### 2.2 Como o navegador interpreta isso
...
![Árvore DOM mostrando a hierarquia de elementos HTML: html contendo head e body, com seus respectivos filhos como meta, title, h1 e p](image.png)

*Figura 1 — Árvore DOM simples*

---

## 3. Conteúdo e hierarquia: títulos e parágrafos

### 3.1 h1 a h6: hierarquia e leitura
...
### 3.2 p: parágrafo como unidade de texto
...
### 3.3 strong vs em: significado semântico
...
!![Hierarquia visual de títulos em uma página: h1 como título principal, seguido por dois h2 como subtítulos, e sob um deles dois h3 como subtítulos menores](image-1.png)
...
## 5. Links e imagens (a, img)

### 5.1 Links absolutos x relativos
...
### 5.4 Imagens: src, alt, width/height
...
## 6. Estrutura semântica de página

### 6.1 Por que semântica existe
...
### 6.2 Quando usar header, nav, main, section, article, footer
...
![Wireframe semântico de uma página mostrando as regiões principais: header no topo, nav ao lado esquerdo, main contendo section e article no centro, e footer na base](image-2.png)
*Figura 3 — Wireframe semântico*

---

## 7. Formulários básicos

### 7.1 form: action e method (GET x POST)
...
| | |
|---|---|
| ![Dois diagramas lado a lado mostrando a associação correta entre label e input: à esquerda, um label com atributo 'for' conectado a um input com 'id' correspondente; à direita, um exemplo de campo de e-mail com label "E-mail" e input type="email"](image-3.png){width=300px} | ![Exemplo visual de formulário preenchido mostrando campos de texto, e-mail, senha e checkboxes com labels claramente associados](image-4.png){width=400px} |
...
## 8. Boas práticas gerais e erros comuns
