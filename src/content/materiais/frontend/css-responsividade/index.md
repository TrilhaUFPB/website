...
# CSS (Layout Responsivo): Flexbox, Grid e Media Queries
...
## 1. O que é layout responsivo (e o problema que ele resolve)
...
### 1.1 Evolução: desktop fixo → múltiplos tamanhos → mobile-first
...
### 1.2 Conceitos essenciais: viewport, “quebra” no celular, responsivo vs adaptativo
...
### 1.3 Princípios práticos: fluidez e conteúdo guiando o layout
...
### 1.4 As três ferramentas: Flexbox (1D), Grid (2D), Media Queries
...
## 2. Modelo mental de Flexbox (layout principal)
...
### 2.2 Container vs itens; main axis vs cross axis
...
![Diagrama ilustrando os conceitos de Flexbox: container com eixo principal (main axis) horizontal e eixo transversal (cross axis) vertical, mostrando propriedades justify-content e align-items controlando o posicionamento dos flex items](image.png){width=800px}
*Figura 1 — Flexbox: eixos e alinhamentos*
---

### 2.3 Propriedades do container
...
### 2.6 Exemplo padrão de mercado: header e cards com wrap
...
## 3. Modelo mental de Grid (layout mais complexo)
...
### 3.2 Conceitos: tracks, linhas, áreas; 2D vs 1D
...
![Diagrama mostrando a estrutura do CSS Grid: linhas numeradas delimitando tracks (faixas de colunas e linhas), com áreas nomeadas destacadas formando regiões retangulares do layout](image-1.png){width=800px}

*Figura 2 — Grid: linhas, colunas e áreas*


### 3.3 Propriedades essenciais do container
...
### 3.5 Exemplo padrão de mercado: sidebar + conteúdo e grid de cards responsivo
...
## 4. Responsividade na prática: Mobile-first e Media Queries
...
![Diagrama ilustrando a abordagem mobile-first: layout simples e funcional em telas pequenas, com incrementos visuais e estruturais para telas maiores](image-2.png){width=800px}
*Figura 3 — Mobile-first: base + incrementos*


### 4.2 Sintaxe e lógica: min-width vs max-width
...
### 4.3 Breakpoints vêm do conteúdo
...
### 4.4 O que mudar em breakpoints
...
### 4.6 Exemplo mínimo com 2 breakpoints (1 → 2 → 3 colunas)
...
![Demonstração visual de grid responsivo em três breakpoints: mobile com cards em 1 coluna, tablet com 2 colunas e desktop com 3 colunas, mantendo gap e padding consistentes](image-3.png){width=800px}
*Figura 4 — Cards responsivos mudando colunas por breakpoint*

---

## 5. Boas práticas de layout (para não virar “CSS de gambiarra”)
...
### 5.1 Comece simples: fluxo normal + max-width + padding
...
### 5.2 Evitar height fixa (quando possível)
...
### 5.3 Preferências que ajudam o layout “respirar”
...
### 5.4 Padronização com tokens simples
...
### 5.5 Debug de layout: pensar em caixas
...
### 5.7 Responsividade sem excessos
