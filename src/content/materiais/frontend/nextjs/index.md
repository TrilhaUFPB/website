...
## 1. React x Next.js: qual problema o Next resolve?
...
## 2. App Router e roteamento por pastas (app/)
...
## 3. Server Components x Client Components
...
## 6. Deploy (conceito) e ambiente de produção
...
## 7. Boas práticas de organização e mentalidade de projeto
