---
title: Performance, Segurança e UX
description: 
category: Frontend
order: 13
---

# 12. Performance, Segurança e UX (Web)
...
## 1. Por que Performance + Segurança + UX andam juntos
...
## 2. Performance (fundamentos práticos)
...
### 2.1 O que significa “rápido” na Web
...
### 2.2 Principais gargalos do front-end
...
### 2.3 Boas práticas de performance (sem depender de framework)
...
### 2.4 Medir antes de “otimizar no escuro”
...
## 3. SEO essencial (o mínimo bem feito)
...
## 4. Segurança: noções de XSS (defensivo e conceitual)
...
## 5. Feedback visual: loading, erro, sucesso (UX aplicada)
...
## 6. UX (fundamentos que todo dev precisa)
