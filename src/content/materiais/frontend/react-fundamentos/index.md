...
## 2. Componentes (Function Components)
...
## 3. JSX e TSX (o “HTML dentro do JS” sem mito)
...
## 5. State (useState) — quando a UI precisa “lembrar”
...
## 6. Eventos no React (comparando com DOM)
...
## 7. Formulários controlados (o padrão “profissional”)
...
## 8. Renderização de listas (map) e keys
...
## 9. Boas práticas de estrutura e legibilidade
