---
title: React (Intermediário)
description: 
category: Frontend
order: 10
---

# 9. React (Intermediário) com TypeScript
...
## 1. O “degrau” intermediário no React: estado, efeitos e dados remotos
...
## 2. useEffect (o hook de efeitos) — modelo mental certo
...
---
![Figura 1 — Linha do tempo do useEffect](image.png)
*Figura 1 — Linha do tempo do `useEffect` (render → commit → effect → cleanup)*


## 3. Consumo de APIs no React (fetch + useEffect)
...
## 4. Loading e erro (estados de UI “de verdade”)
...
## 5. useContext (compartilhar dados sem prop drilling)
...
## 6. Organização de projeto (estrutura simples e escalável)
...
## 7. Formulários mais complexos (sem libs, mas com padrão bom)
...
## 8. Próximos passos (contexto, sem ensinar agora)
