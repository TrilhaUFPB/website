...
# Aula: Introdução à Análise de Dados
...
![Ciclo de analise de dados](../images/data-analysis-process.png)

### 2. Propriedades dos dados
...
![dados estruturados x nao estruturados](../images/tipos_dados.png)


#### 2.3 Dados qualitativos (categóricos)
...
#### 2.4 Dados quantitativos (numéricos)
...
![dados qualitativos x dados quantitativos](../images/tipos_variaveis.webp)
...
![Operações no Pandas](../images/pandas_operations.webp)
...
![Matplotlib Exemplos](../images/matplotlib_examples.png)
...
![Seaborn Exemplos](../images/seaborn_examples.png)

---

#### 3.4 Relação entre as bibliotecas
...
#### 4.1 Inspeção inicial do dataset
...
#### 4.3 Detecção de dados ausentes
...
#### 5.4 Normalização ou padronização de dados
...
![Normalização vs Padronização](../images/normalizacao_vs_padronizacao.png)

---

#### 5.5 Criação de flags/binários indicativos  
...
![Flags Binárias](../images/flags_binarias.png)

---

#### 5.6 Tratamento de outliers
Outliers podem ser:
...
![Boxplot](../images/boxplot_outliers_exemplo.webp)
...
#### 6.1 Tipos de gráfico principais
...
![Gráficos](../images/cheatsheet_graficos.png)
