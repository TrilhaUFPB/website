...
## 3.1. A lógica do ecossistema de dados
...
## 3.2. Pipeline de uma aplicação de dados
...
### 3.2.2. Armazenamento e estruturação
...
### 3.2.3. Processamento e transformação
