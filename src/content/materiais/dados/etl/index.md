...
#### 4.2.1.1. O que é o processo de extração (extract)
...
#### 4.2.2.1. O que é o processo de transformação (transform)
...
#### 4.2.2.2. Ferramentas de transformação
...
#### 4.2.2.3. Qualidade e limpeza de dados
...
#### 4.2.3.1. O que é o processo de armazenar (Load)
...
#### 4.2.3.2. Sistemas de armazenamento
...
#### 4.2.3.3. Arquiteturas de armazenamento
