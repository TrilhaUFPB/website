---
title: Mecanismos de Autenticação
...
![Google Cloud API](/api/materiais-assets/backend/mecanismos-de-autenticacao/assets/google-cloud-api.png)
...
### 2. Rotação de Chaves (Key Rotation)
...
![Session Cookie](/api/materiais-assets/backend/mecanismos-de-autenticacao/assets/session-cookie.png)
...
![JWT Part 1](/api/materiais-assets/backend/mecanismos-de-autenticacao/assets/jwt-pt1.png)
![JWT Part 2](/api/materiais-assets/backend/mecanismos-de-autenticacao/assets/jwt-pt2.png)
...
![OAuth](/api/materiais-assets/backend/mecanismos-de-autenticacao/assets/oauth.png)
...
![Mutual TLS](/api/materiais-assets/backend/mecanismos-de-autenticacao/assets/mutual-tls.png)
