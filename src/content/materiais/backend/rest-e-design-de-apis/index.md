...
## 1. O Path (Caminho): Path vs Query Params
...
## 3. Headers Essenciais e Content Negotiation
...
## 3.1. Como o FastAPI lida com Headers por padrão
...
## 5. Status Codes no Contexto REST
...
## 3. Update (Atualizar) -> PUT ou PATCH
...
### 1. JSON Merge Patch (RFC 7396) - O mais simples
...
### 2. JSON Patch (RFC 6902) - O "avançado"
...
### 1. Versionamento na URI (Path Versioning) - **Mais Comum**
...
### 2. Versionamento no Header (Header Versioning)
