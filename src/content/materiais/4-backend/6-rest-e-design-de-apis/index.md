...
Para aprofundar seus conhecimentos sobre REST e design de APIs, confira os recursos abaixo:

- [Curso de FastAPI - Rest API com Python (Backend Completo) (Playlist)](https://www.youtube.com/playlist?list=PLpdAy0tYrnKy3TvpCT-x7kGqMQ5grk1Xq)

```quiz
- tipo: single
  pergunta: Você está desenhando uma rota para permitir que o cliente apague um usuário. Qual das opções abaixo segue os princípios REST?
  opcoes:
    - texto: "`DELETE /users/1`"
      correta: true
...
- **[Fielding]:** [Architectural Styles and the Design of Network-based Software Architectures (Tese Original)](https://roy.gbiv.com/pubs/dissertation/top.htm)
...
- **[IBM]:** [What Is a REST API (RESTful API)?](https://www.ibm.com/think/topics/rest-apis)
...
- **[Microsoft]:** [REST API Design Guidelines (Azure Architecture Center)](https://learn.microsoft.com/en-us/azure/architecture/best-practices/api-design)
...
- **[William Durand]:** [Please. Don't Patch Like That.](https://williamdurand.fr/2014/02/14/please-dont-patch-like-that/)
...
- **[Spring]:** [Building a Hypermedia-Driven RESTful Web Service (HATEOAS)](https://spring.io/guides/gs/rest-hateoas/)
