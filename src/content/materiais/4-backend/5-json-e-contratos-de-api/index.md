...
- [5.0. Visão Geral: Dados e Contratos](#50-visao-geral-dados-e-contratos)
- [5.1. JSON como formato de troca de dados](#51-json-como-formato-de-troca-de-dados)
- [5.2. Tipos, estruturas e armadilhas comuns](#52-tipos-estruturas-e-armadilhas-comuns)
- [5.3. Serialização e deserialização](#53-serializacao-e-deserializacao)
- [5.4. Contratos de entrada e saída](#54-contratos-de-entrada-e-saida)
- [5.5. Evolução de contratos e compatibilidade](#55-evolucao-de-contratos-e-compatibilidade)
- [5.6. OpenAPI como contrato formal](#56-openapi-como-contrato-formal)
- [5.7. Modelagem consistente de erros](#57-modelagem-consistente-de-erros)
