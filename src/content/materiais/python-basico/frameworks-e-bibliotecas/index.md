...
![Estrutura de exemplo](image/bibliotecas/estrutura_projeto.png)
...
### Frameworks Python
![Principais Frameworks Python](image/frameworks/frameworks_python.png)

### Frameworks JavaScript
![Principais Frameworks JavaScript](image/frameworks/frameworks_js.png)
...
![Flask executando no terminal](image/frameworks/flask_terminal.png)

Ao acessar o link **http://127.0.0.1:5000** no browser, você verá a página a seguir:

![Página web Flask](image/frameworks/flask_web.png)
