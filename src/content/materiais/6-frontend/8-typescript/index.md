...
---
![Figura 1 — Fluxo do TypeScript no front-end](/api/materiais-assets/6-frontend/8-typescript/assets/image.png)
...
---
![Figura 2 — Camadas: tipo vs valor (compile-time vs runtime)](/api/materiais-assets/6-frontend/8-typescript/assets/image-1.png)
...
---
![Figura 3 — Union + narrowing (string | null → checagem → uso seguro)](/api/materiais-assets/6-frontend/8-typescript/assets/image-2.png)
...
---
![Figura 4 — Promise<T> (pending → resolve(T) / reject(Error))](/api/materiais-assets/6-frontend/8-typescript/assets/image-3.png)
