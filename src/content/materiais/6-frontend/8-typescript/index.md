...
# 8. TypeScript (Fundamentos) — JavaScript com “contratos” para o dia a dia
...
---
![alt text](/api/materiais-assets/6-frontend/8-typescript/assets/image.png)
...
## Modelo mental: inferência vs anotações
...
---
![alt text](/api/materiais-assets/6-frontend/8-typescript/assets/image-1.png)
...
## Tipos básicos (a base que você usa sempre)
...
---
![alt text](/api/materiais-assets/6-frontend/8-typescript/assets/image-2.png)
...
## Tipar funções (o ponto de maior valor no dia a dia)
...
## Objetos tipados: interfaces e types (comparar com clareza)
...
## Arrays tipados (lista de coisas)
...
## Promise<T> e assincronicidade tipada
...
---
![alt text](/api/materiais-assets/6-frontend/8-typescript/assets/image-3.png)
...
## Boas práticas e “higiene” de TypeScript para iniciantes
