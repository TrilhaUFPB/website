...
import { peopleFounders } from '@trilha/people/profiles';
import { allStudents, completedCohorts } from '@trilha/people/cohorts';
...
export default function Numbers() {
  ...
  const studentsTotal = allStudents.length;
  const stats = [
    ...
    { k: String(completedCohorts.length), l: t('numbers.labels.cohortsCompleted') },
